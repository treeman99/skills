...
- 출처: `stablyai/orca` · `skills/orchestration/SKILL.md` (커밋 `37631030`, 2026-09-13). 본문의 마지막 내용 변경은 `bba68b1b`이고, `37631030`(v1.4.200·v1.4.201·v1.4.202 태그 포함)까지 상류 stub 8종은 바이트 단위로 같다 — 커밋 표기만 대조 시점(2026-09-14 재확인)에 맞춰 올렸다.
