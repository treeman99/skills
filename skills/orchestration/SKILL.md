...
- 출처: `stablyai/orca` · `skills/orchestration/SKILL.md` (커밋 `775a9326`, 2026-09-15). 본문의 마지막 내용 변경은 `bba68b1b`이고, `775a9326`(v1.4.200~v1.4.203 태그 포함)까지 상류 stub 8종은 바이트 단위로 같다 — 커밋 표기만 대조 시점(2026-09-15 재확인)에 맞춰 올렸다.
